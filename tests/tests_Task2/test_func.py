...
class Test_Func:
    ...
    @pytest.mark.parametrize(
        ...
        (filter, (lambda x: len(x) == 3,), ["cat", "dog", "elephant", "fox"], ["cat", "dog", "fox"]),
        (filter, (lambda x: x % 3 == 0,), range(1, 11), [3, 6, 9]),
        (filter, (lambda x: x.startswith("A"),), ["Apple", "Banana", "Apricot", "Cherry"], ["Apple", "Apricot"]),
        
        (enumerate, (), ["first", "second", "third"], [(0, "first"), (1, "second"), (2, "third")]),
        (enumerate, (), [100, 200, 300], [(0, 100), (1, 200), (2, 300)]),
        
        (zip, (["x", "y", "z"],), [1, 2, 3], [(1, "x"), (2, "y"), (3, "z")]),
        (zip, ([10, 20],), [1, 2, 3], [(1, 10), (2, 20)]), 
        (zip, ([True, False], [0.1, 0.2]), [1, 2], [(1, True, 0.1), (2, False, 0.2)]),
        
        (reduce, (lambda x, y: max(x, y),), [3, 1, 4, 1, 5], [5]),
        (reduce, (lambda x, y: min(x, y),), [3, 1, 4, 1, 5], [1]),
        (reduce, (lambda x, y: x + " " + y,), ["hello", "world", "!"], ["hello world !"]), 
